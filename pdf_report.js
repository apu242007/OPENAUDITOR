...
module.exports = function buildPdfHtml(ins, uploadsDir, branding) {
  ...
  var appName = E(b.appName || 'OPEN AUDITOR');
  var cover = logoHtml || '<div class="app-name">' + appName + '</div>';
  ...
  html += '<div class="pdf-ftr"><span>'+E(ins.templateName.slice(0,45))+'</span><span class="br">'+E(b.footerText || b.appName || 'OPEN AUDITOR')+'</span><span>Pagina <span class="pageNumber"></span></span></div>';
