...
## 18. Guía Avanzada y Documentación Técnica

Para no hacer este README principal infinito, movimos toda la documentación profunda a una guía separada.

👉 **[Ver Guía Avanzada (Arquitectura, Modelo de Datos, Seguridad, API, Variables de Entorno, Backup, FAQ y Troubleshooting)](docs/GUIA_AVANZADA.md)**
